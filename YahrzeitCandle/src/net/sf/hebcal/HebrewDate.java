/*
   $Header: /cvsroot/hebcal/java/hebcalJ/src/main/java/net/sf/hebcal/HebrewDate.java,v 1.1 2007/01/07 13:13:13 sadinoff Exp $
...
public class HebrewDate implements Comparable {
	...
	public void setDate(Date date) {
		this.gMonth = Integer.parseInt(DateTimeFormat.getFormat("M").format(date));
		this.gDayOfMonth = Integer.parseInt(DateTimeFormat.getFormat("d").format(date));
		this.gYear = Integer.parseInt(DateTimeFormat.getFormat("y").format(date));

		//System.out.println("gMonth is " + gMonth);
	...
	public void setHebrewDate(final int newHMonth, final int newHDayOfMonth,final int newHYear)
			throws HebrewDateException {
		if (newHMonth < 0 || newHMonth > getLastMonthOfHebrewYear(newHYear))
...
//			newHDayOfMonth = getLastDayOfHebrewMonth(newHMonth);
	...
	public String getHebrewMonthAsString() {
		...
		/*if (isThisHebrewLeapYear() && hebrewMonth == 12)
			...
			return hebrewMonthProp[hebrewMonth - 1];
	}
	...
	public void setHebrewYear(int year) throws HebrewDateException {
		setHebrewDate(CURRENT_MONTH, CURRENT_DATE, year);
	}
...
public static String day_of_week[]={"Sunday","Monday","Tuesday","Wednesday",
